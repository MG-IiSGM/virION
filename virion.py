...
from misc_virion import check_create_dir, check_file_exists, check_remove_file, execute_subprocess, check_reanalysis
...
def main():
    ...
    def get_arguments():
        ...
        input_group.add_argument('-s', '--samples', metavar='Samples', type=str,
        ...
        input_group.add_argument('-p', '--primers', type=str, default='~/artic-ncov2019/primer_schemes/',
                                 required=False, help='Bed file including primers to trim')

        input_group.add_argument('-C', '--noclean', required=False, action='store_true',
                                 help='Clean unwanted files for standard execution')

        guppy_group = parser.add_argument_group(
            'Guppy parameters', 'Parameters for Guppy basecalling and barcoding')

        guppy_group.add_argument('-c', '--config', type=str, default='dna_r9.4.1_450bps_hac.cfg', required=True,
        ...
        guppy_group.add_argument('--barcode_kits', type=str, required=False,
        ...
        quality_group = parser.add_argument_group(
            'Quality parameters', 'Parameters for different trimming conditions')

        quality_group.add_argument('-cov', '--coverage30', type=int, default=90, required=False,
        ...
        params_group = parser.add_argument_group(
            'Parameters', 'Parameters for different stringent conditions')

        params_group.add_argument('-t', '--threads', type=int, dest='threads',
                                  required=False, default=30, help='Threads to use (30 threads by default)')

        params_group.add_argument('-m', '--memory', type=int, dest='Memory',
                                  required=False, default=64, help='Max memory to use')
